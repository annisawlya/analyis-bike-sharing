...
st.markdown("""
- **Nama**: Annisa Aulia
- **Email**: annisaaulia478@gmail.com
- **Dicoding ID**: annisaauliaaa
""")
...
# Membuat perbandingan penyewaan saat musim panas dengan musim lainnya
...
st.write("""
- Dilihat dari diagram batang yang ditampilkan, musim salju menjadi musim yang paling sedikit dari musim lainnya, kemudian musim semi selanjutnya. Musim Panas berada pada urutan kedua terbanyak penyewa. Musim gugur menjadi musim terbanyak penyewa sepeda. Kesimpulannya, pada musim panas mengalami peningkatan penyewaan namun, jika dibandingkan dengan musim gugur, musim gugur menjadi ururtan terbanyak dan diikuti musim panas di urutan kedua.
...
st.caption('Copyright (c) Annisa Aulia')
